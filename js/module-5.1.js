...
// };
// // const numbers = [20, 10, 9, 63, 75];
// // const showFunction = (sum) => console.log(sum);
// // sumArray(numbers, showFunction);
// // // callback(numbers);
...
// //   callback(words.filter((word) => condition(word)));
// // };

// // const words = ["Olga", "Vlad", "Alina", "Anton", "alex"];
// // const condition = (words) => words[0].toLowerCase() === "a";
// // const showResult = (show) => console.log(show);
// // filterWords(words, condition, showResult);

// const capitalizeStrings = (strings, callback) =>
//   callback(
//     strings.map(
//       (str, index, arr) => (arr[index] = str[0].toUpperCase() + str.slice(1)),
//     ),
//   );
...
// };
// const numbers = [10, 3, 6, 9, 8];
// const doubleNumber = (numbers) => numbers.map((number) => number * 2);

// console.log(doubleArray(numbers, doubleNumber));
...
// const getName = (heroes) => heroes.map((heroe) => heroe.name);

// console.log(getName(heroes));

// Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких hairColor дорівнює 'Black'

// const getHairColor = (heroes) =>
//   heroes.filter((heroe) => heroe.appearance.hairColor === "Black");

// console.log(getHairColor(heroes));
